...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { conteudo: @produto.conteudo, estoque: @produto.estoque, preco: @produto.preco, titulo: @produto.titulo, url: @produto.url } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { conteudo: @produto.conteudo, estoque: @produto.estoque, preco: @produto.preco, titulo: @produto.titulo, url: @produto.url } }
